...
console.log('🔄 Find and Replace Variables - Library Import Version');

// Configuration
var searchPattern = '4xl';   // Text pattern to search for in variable names
var replacePattern = '2xl';  // Text pattern to replace with
