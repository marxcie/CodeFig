...
- Scripts are **plain ES2017 JavaScript**, despite the `.ts` extension (the extension is only for IDE convenience). No `interface`, `type`, `as`, or annotations — they reach `new Function` verbatim and throw.
