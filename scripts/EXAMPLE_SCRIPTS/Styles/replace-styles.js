...
var __codefigPanel = {
  blocks: [
    { key: "searchIn", type: "string", placeholder: "color/*" },
    ...
    { type: "heading", text: "Library styles must already be in the file", level: 2 },
    { type: "paragraph", attachTo: "previous",
    ...
    { key: "searchFor", type: "string", placeholder: "Text V1" },
    { key: "replaceWith", type: "string", placeholder: "Text V2" },
    { type: "paragraph", attachTo: "previous",
