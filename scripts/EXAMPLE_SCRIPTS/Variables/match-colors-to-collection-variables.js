...
var __codefigPanel = {
  blocks: [
    { type: "heading", text: "Palettes" },
    { key: "collections", type: "multiselect", options: "variableCollections" },
    { type: "paragraph", attachTo: "previous",
      text: "Tick every collection that might hold a matching colour token." },
    { type: "divider" },
    { type: "heading", text: "Loose matching" },
    { key: "looseMatching", type: "boolean", label: "Match near misses" },
    { type: "paragraph", attachTo: "previous",
      ...
      text: "How far a colour may sit from a token and still count, measured as LAB ΔE: conservative 2,\nstandard 4, aggressive 6. Below about 2 the eye cannot tell them apart." },
    {
      ...
      showWhen: { looseMatching: true, matchTolerance: "custom" }
    },
    { key: "verboseLogging", type: "boolean", label: "Verbose console output" },
    { type: "paragraph", attachTo: "previous",
